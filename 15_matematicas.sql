-- ABS
--Converte negativo para positivo
select a.FIRST_NAME,
       a.SALARY,
...
--Podemos especificar o valor minimo e máximo do random
...
-- ROUND
--Round é utilizado para arredondar valores de acordo com o que está entre parenteses
select ROUND(45.923,2)T1, 
       ROUND(45.923)T2, 
       ROUND(45.323,1)T3, 
       ROUND(45.323,-1) T4,
...
-- TRUNC
--trunc é semelhante a round, podendo ser interchanchable
...
--SIGN(valor)
--Sign retorna -1 para valores negativos, 1 para positivos, null p/ nulo e 0 p/ 0
...
--POWER(valor, n)
--Power é utilizado para elevar a n potencia
select  power(3,2)T1, 
        power(3,3)T2, 
        power(3,4)T3,
        power(2,2)T4
