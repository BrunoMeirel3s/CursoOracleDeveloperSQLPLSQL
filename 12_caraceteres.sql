-- Exemplos com ASCII
--ascii é utilizado quando quisermos descobrir o código ascii de um caracter
...
-- Exemplos com UPPER( )
--Coloca os resultados em maiúsculo
select a.DEPARTMENT_NAME nome_depto,  
...
-- Exemplos com CONCAT( )
--Realiza a concatenação de dois ou mais valores
select a.FIRST_NAME,
       a.LAST_NAME,
...
--usando || podemos concatenar os valores, inserindo espaços e números
select a.FIRST_NAME,
       a.LAST_NAME,
...
-- Exemplos com LPAD( )
--preenche de zeros a esquerda no exemplo abaixo
--podemos personalizar a quantidade de caracteres máximo
...
-- Exemplos com RPAD( )
--similar ao LPAD porém insere os valores a direita
select a.EMPLOYEE_ID,
...
-- Exemplos com SUBSTR( )
--utilizado para trazer parte da expressão
--abaixo estamos visualizando da posição dois até a 4
...
-- Exemplos com INSTR( )
--instr retorna a posição na qual se encontra a letr
...
-- Exemplos com LTRIM( )
--ltrim remove valores a esquerda, podendo ser valores em branco ou não
SELECT a.JOB_TITLE,
       LTRIM(a.JOB_TITLE,'A') posicao FROM HR.JOBS a;
       
--remove não a combinação porém sim as letras AFPS a esquerda
...
-- Exemplos com RTRIM( )
--remove os valores definidos a direita, podendo ser caracteres em branco
...
-- Exemplos com LENGTH( )
-- Retorna q quantidade de caracteres do campo
SELECT a.JOB_TITLE,
       LENGTH(a.JOB_TITLE) tamanho FROM HR.JOBS a;

-- Exemplos com TRANSLATE( )
--Função translate é utilizada pra troca uma letra por outra
SELECT a.JOB_TITLE,
...
--replace é utilizado para substituir completamente o valor no campo
SELECT a.JOB_TITLE,
...
--Decode é utilizado para substituir um valor por outro
SELECT a.JOB_TITLE,
       decode(JOB_TITLE,
