--exemplo case
--Case pode ser utilizado como comando de descição, utilizando o when podem definir as regras
--para classificar oua grupar uma determinada faixa salárial como no exemplo abaixo
...
--exemplo case
--is not null é utilizado para verificar se o registro
--possui um campo preenchido
